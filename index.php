<?php
// index.php - Fixed version with error handling
...
try {
    ...
    // Try to get checked out assets with purpose, fallback to regular method
    try {
        if (method_exists($asset, 'getCheckedOutAssetsWithPurpose')) {
            $checked_out = $asset->getCheckedOutAssetsWithPurpose();
        } else {
            $checked_out = $asset->getCheckedOutAssets();
        }
    } catch (Exception $e) {
        error_log("Error getting checked out assets: " . $e->getMessage());
        $checked_out = $asset->getCheckedOutAssets();
    }
    ...
    <style>
        ...
        * {
        ...
        @media (max-width: 768px) {
            ...
            /* Hide PURPOSE column on mobile to save space */
        ...
        @media (max-width: 480px) {
            /* Hide DUE BACK column on very small screens */
...
<body>
    ...
    <nav class="navbar">
        <div class="navbar-container">
            ...
            <div class="navbar-nav ms-auto">
                ...
                <a class="nav-link" href="ai_scanner.php">AI Assets Scanner</a>
    ...
    <div class="main-container">
        ...
        <div class="page-header">
            <h1 class="page-title">GEAR CONTROL SYSTEM</h1>
        </div>
        ...
        <div class="stats-grid">
            <div class="stat-card">
                ...
                <div class="stat-number"><?php echo isset($stats['total_assets']) ? $stats['total_assets'] : '0'; ?></div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-number"><?php echo isset($stats['available']) ? $stats['available'] : '0'; ?></div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-number"><?php echo isset($stats['checked_out']) ? $stats['checked_out'] : '0'; ?></div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-number"><?php echo isset($overdue) ? count($overdue) : '0'; ?></div>
        ...
        <div class="quick-actions">
            ...
            <a href="crew_checkout.php" class="action-card">
                <div class="action-icon">
                    <i class="fas fa-users"></i>
                </div>
                <div class="action-title">CREW CHECKOUT</div>
                <div class="action-desc">Assign equipment to crew for shoots</div>
            </a>
        ...
        <div class="modern-card">
            <div class="card-header">
                ...
                <span class="badge badge-warning"><?php echo isset($checked_out) ? count($checked_out) : '0'; ?> ITEMS</span>
            </div>
            <div class="card-body">
                    ...
                    <table class="modern-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $item['checkout_date'] ? date('M j, Y', strtotime($item['checkout_date'])) : 'N/A'; ?></td>
                                <td>
                                    <?php if (!empty($item['purpose'])): ?>
                                        <span class="purpose-text"><?php echo htmlspecialchars($item['purpose']); ?></span>
                                    <?php else: ?>
                                        <span class="purpose-empty">No purpose specified</span>
                                    <?php endif; ?>
                                </td>
                                <td><?php echo $item['expected_return_date'] ? date('M j, Y', strtotime($item['expected_return_date'])) : 'N/A'; ?></td>
                                <td>
                                    <?php if ($item['expected_return_date'] && strtotime($item['expected_return_date']) < time()): ?>
