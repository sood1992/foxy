...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    try {
        ...
        foreach ($crew_assignments as $crew_member => $equipment_data) {
        ...
        if ($total_assigned > 0) {
            ...
            // Send emails and prepare printouts
            foreach ($results as $crew_member => $crew_data) {
                if (!empty($crew_data['equipment'])) {
                    ...
                    if (!empty($successful_equipment) && $crew_data['email']) {
...
<body>
    ...
    <div class="main-container">
        ...
        <?php $results = $_SESSION['crew_checkout_results']; ?>
        <div class="main-card">
            <div class="card-header">
                <h2>
                    <i class="fas fa-check-circle"></i> Checkout Complete
                </h2>
                <p style="margin: 10px 0 0 0; opacity: 0.9;"><?php echo htmlspecialchars($results['project_name']); ?></p>
            </div>
            <div class="card-body">
                <div class="print-section">
                    ...
                    <div class="results-section">
                        <?php foreach ($results['results'] as $crew_member => $crew_data): ?>
                        ...
                        <div class="crew-result" id="receipt-<?php echo htmlspecialchars($crew_member); ?>">
                            <h4>
                                ...
                                <button class="btn btn-sm btn-secondary ms-auto" onclick="printSingleReceipt('<?php echo htmlspecialchars($crew_member); ?>')">
