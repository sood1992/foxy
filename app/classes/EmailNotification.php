...
class EmailNotification {
    private static $from_email = 'foxy@neofoxmedia.com';
    private static $from_name = 'Neofox Gear Control';
    private static $admin_emails = ['team@neofoxmedia.com', 'sood1992@gmail.com'];
    
    // SMTP Configuration based on your hosting settings
    private static $smtp_host = 'mail.neofoxmedia.com';
    private static $smtp_port = 465;  // SSL port
    private static $smtp_username = 'foxy@neofoxmedia.com';
    private static $smtp_password = 'foxyfoxy!@';
